...
const translations = {
    en: {
        ...
        heroTitle: "Stop Overpaying for Cable. <span class='text-cyan-400'>Start StreamVerse.</span>", heroSubtitle: "50,000+ Live Channels, Movies, and Series in Stunning 4K/HD. No Contracts. No Hidden Fees.", heroSolve: "The Ultimate Entertainment Universe", heroCTA: "GET STARTED NOW", heroUrgency: "Join 50,000+ Happy Streamers",
        ...
        pricingBenefit1: "50,000+ Live Channels", pricingBenefit2: "Stunning 4K/HD Quality", pricingBenefit3: "Anti-Freeze™ Technology", pricingBenefit4: "Multi-Device Compatibility", pricingBenefit5: "24/7 Premium Support", pricingBenefit6: "140,000+ Movies & Series", pricingBenefit7: "Catch-up & EPG", pricingBenefit8: "No Buffer Technology", pricingBenefit9: "Safe & Secure Payment", pricingBenefit10: "Instant Activation",
    ...
    es: {
        ...
        heroTitle: "Deja de pagar de más por el cable. <span class='text-cyan-400'>Empieza StreamVerse.</span>", heroSubtitle: "Más de 50,000 canales en vivo, películas y series en impresionante 4K/HD. Sin contratos. Sin cargos ocultos.", heroSolve: "El universo definitivo del entretenimiento", heroCTA: "EMPIEZA AHORA", heroUrgency: "Únete a más de 50,000 streamers felices",
        ...
        pricingBenefit1: "+50,000 Canales en Vivo", pricingBenefit2: "Calidad 4K/HD impresionante", pricingBenefit3: "Tecnología Anti-Freeze™", pricingBenefit4: "Compatibilidad multidispositivo", pricingBenefit5: "Soporte Premium 24/7", pricingBenefit6: "+140,000 Películas y Series", pricingBenefit7: "Catch-up y EPG", pricingBenefit8: "Tecnología sin Buffer", pricingBenefit9: "Pago Seguro", pricingBenefit10: "Activación Instantánea",
    ...
    fr: {
        ...
        heroTitle: "Arrêtez de surpayer le câble. <span class='text-cyan-400'>Commencez StreamVerse.</span>", heroSubtitle: "Plus de 50 000 chaînes en direct, films et séries en 4K/HD époustouflante. Sans contrat. Sans frais cachés.", heroSolve: "L'univers ultime du divertissement", heroCTA: "COMMENCER MAINTENANT", heroUrgency: "Rejoignez plus de 50,000 streamers heureux",
        ...
        devicesTitle: "Watch Everywhere - On All Your Devices", devicesSubtitle: "We understand you love choice in what you watch, and where you watch it. Simply connect to your TV, computer, tablet or smartphone and enjoy your favorite programming anywhere, anytime.",
        featuresTitle: "The Last Entertainment Service You'll Ever Need", featuresSubtitle: "We solve the biggest pains of traditional TV. This is more than a cable TV alternative, it's an upgrade.",
        feature1Title: "50 000+ Chaînes", feature1Desc: "Never miss another live sports event, news broadcast, or hit series again. Your entertainment is now limitless.", feature2Title: "Stunning 4K/HD Quality", feature2Desc: "Experience heart-pounding action in cinema-quality resolution that makes you feel like you're right there.", feature3Title: "Anti-Freeze™ Technology", feature3Desc: "Our powerful servers ensure silky-smooth streaming without the agonizing buffering that ruins the best moments.", feature4Title: "Multi-Device Compatibility", feature4Desc: "Watch on your TV, laptop, tablet, or phone. Your shows, your rules, anywhere you go.",
        channelsTitle: "A Universe of Channels Awaits", channelsSubtitle: "From premium sports and movie channels to international content, we have something for everyone.",
        geminiTitle: "Don't Know What to Watch?", geminiSubtitle: "Describe your perfect movie night or the sports leagues you love. Our AI will build a personalized guide just for you.",
        geminiPlaceholder: "e.g., 'I love Premier League soccer, true crime documentaries, and classic 80s action movies...'", geminiCTA: "✨ Generate My Channel Guide", geminiError: "Sorry, we couldn't generate your guide at the moment. Please try again later.", geminiEmpty: "Please tell us what you like to watch first!",
        ...
        pricingBenefit1: "50 000+ Chaînes en Direct", pricingBenefit2: "Qualité 4K/HD époustouflante", pricingBenefit3: "Technologie Anti-Freeze™", pricingBenefit4: "Compatibilité multi-appareils", pricingBenefit5: "Support Premium 24/7", pricingBenefit6: "140 000+ Films et Séries", pricingBenefit7: "Catch-up et EPG", pricingBenefit8: "Technologie sans Buffer", pricingBenefit9: "Paiement Sécurisé", pricingBenefit10: "Activation Instantanée",
        ...
        <table className="comparison-table">
            ...
            <tbody>
                ...
                <tr className="bg-gray-800">
                    ...
                    <td className="cost text-green-400 highlight">$19.99</td>
                ...
                <div className="container mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-12">
                        <div className="bg-card-dark p-8 rounded-lg border-2 border-gray-700 flex flex-col">
                            <h3 className="text-2xl font-bold mb-2">{t('plan1Title')}</h3><p className="text-gray-400 mb-6">{t('plan1Desc')}</p><p className="text-4xl font-extrabold mb-6"><span className="text-2xl text-gray-400 line-through">${(39.99 + (screens - 1) * 10).toFixed(2)}</span> ${(19.99 + (screens - 1) * 10).toFixed(2)}</p>
