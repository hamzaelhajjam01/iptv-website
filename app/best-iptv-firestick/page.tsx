                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div id="installation" className="mb-20">
                        ...
                        <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-8 mb-8">
                            ...
                            <div className="mt-8 rounded-xl overflow-hidden border-2 border-blue-500/30 flex justify-center bg-gray-900/40 p-6">
                                <Image
                                    src="/images/premium-multi-device-iptv.png"
                                    alt="StreamVerse IPTV works on Firestick and all devices - multi-screen streaming"
                                    width={1024}
                                    height={1024}
                                    className="w-full max-w-2xl h-auto object-contain drop-shadow-2xl rounded-lg"
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            ...
                            <div className="bg-card-dark p-8 rounded-lg border-2 border-gray-700 flex flex-col hover:border-blue-500/50 transition-all duration-300">
                                <div className="mb-4 relative w-full h-48">
                                    <Image src="/images/boxes/Box_IPTV_MONTH3.png" alt="3 Months IPTV Plan for Firestick" fill className="object-contain" />
                                </div>
                                ...
                                <p className="text-4xl font-extrabold mb-6 text-white">
                                    <span className="text-2xl text-gray-400 line-through">$39.99</span> $19.99
                                </p>
                                ...
                                <button
                                    onClick={() => openCheckout('3 Months Plan - 1 Screen', '$19.99', '/images/boxes/Box_IPTV_MONTH3.png')}
