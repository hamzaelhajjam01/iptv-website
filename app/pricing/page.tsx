                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div className="flex-1 text-left">
                                ...
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    StreamVerse offers <span className="text-white font-medium">premium IPTV service</span> at significantly lower costs than cable, eliminating expensive hardware rentals and long-term contracts. With plans starting at just <span className="text-white font-medium">$9.99/mo</span>, you gain access to <span className="text-white font-medium">50,000+ live channels</span>, a massive <span className="text-white font-medium">VOD library</span> exceeding 140,000 titles, and advanced features like <span className="text-white font-medium">Anti-Freeze Technology</span>, <span className="text-white font-medium">EPG</span>, and <span className="text-white font-medium">Catch-up TV</span>.
                                </p>
                                <p className="text-gray-300 leading-relaxed">
                                    Our <span className="text-white font-medium">multi-connection</span> options are perfect for families, allowing simultaneous streaming on up to 3 screens. Whether you use <span className="text-white font-medium">Firesticks</span>, <span className="text-white font-medium">Android boxes</span>, <span className="text-white font-medium">Smart TVs</span>, or mobile devices, our service works instantly on the hardware you already own. Choose an annual plan to <span className="text-white font-medium">save up to 75%</span> with no hidden fees, no installation charges, and no equipment to return.
                                </p>
                            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-8 text-center hover:border-blue-500/50 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm leading-relaxed">
                                Multi-connection refers to the ability to stream content on multiple devices simultaneously using a single IPTV subscription. When you select 2 or 3 screens in our pricing options, you're allowing that many devices to watch different channels or content at the exact same time. For example, with a 2-screen connection, one family member can watch live sports in the living room while another watches a movie in the bedroom. This is fundamentally different from simply logging into multiple devices—those devices can actually be used concurrently without interrupting each other. Traditional cable TV requires a separate cable box rental ($10-15/month each) for every TV in your home, whereas IPTV multi-connection works across any compatible device (Fire TV, smartphone, tablet, Smart TV) that you already own, with no additional hardware costs.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-8 text-center hover:border-blue-500/50 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm leading-relaxed">
                                VOD stands for Video On Demand, which is essentially your personal streaming library built into the IPTV service—similar to Netflix or Hulu, but included in your subscription at no extra cost. Unlike Live TV channels that broadcast on a fixed schedule, VOD content consists of movies and TV series that you can start, pause, rewind, and watch whenever you want. Our VOD library contains over 140,000 titles spanning multiple genres, languages, and release years. This means you're getting both a full cable replacement (live channels) and a streaming service replacement (on-demand content) in one package. VOD is organized by categories such as Action, Comedy, Drama, 4K Movies, and TV Series, with new releases added regularly. You never pay per rental or per title—unlimited access to the entire library is included in every subscription tier.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-8 text-center hover:border-blue-500/50 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm leading-relaxed">
                                An Electronic Program Guide (EPG) is the digital TV guide that shows you what's currently playing and what's coming up next on each channel, just like the channel guide on cable or satellite TV. A high-quality EPG displays program names, descriptions, start times, and duration for every channel in an easy-to-navigate interface. This is crucial for IPTV usability because without an EPG, you'd have to manually flip through channels to see what's on. StreamVerse provides a comprehensive EPG that covers all major channels with accurate, real-time data that's updated automatically. The EPG also enables advanced features like "catch-up TV," which allows you to go back and watch shows that aired in the past 3-7 days, and "TV guide search," where you can find specific programs across all channels instantly.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-8 text-center hover:border-blue-500/50 transition-all duration-300">
                            ...
                            <p className="text-gray-300 text-sm leading-relaxed">
                                Xtream Codes API is the technical protocol that IPTV players (like IPTV Smarters, TiviMate, or other apps) use to connect to your IPTV service and load your channels, VOD content, and EPG data. When you receive your login credentials in the welcome email, you'll see three key pieces of information: a server URL, a username, and a password. These credentials use the Xtream Codes format, which is the industry standard for professional IPTV services. You simply enter these details once into your IPTV player app, and the app automatically loads everything—your live channel list, VOD library, and program guide—without any manual configuration. This makes setup incredibly simple and ensures compatibility with all major IPTV player apps across every device platform. You'll never need to manually enter M3U playlist URLs or edit configuration files.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-6xl mx-auto mb-16 bg-gray-900/40 border border-gray-800 rounded-xl p-8 text-left">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-8 gap-y-8">
                        <div>
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                Our pricing is significantly lower than traditional cable or satellite TV for several fundamental reasons. First, we don't have the infrastructure costs that cable companies face—there's no need to maintain physical cable lines, satellite dishes, or regional service centers. Second, we don't charge for hardware rentals. Cable providers typically charge $10-15 per month for each cable box, whereas IPTV works on devices you already own like Firesticks, smartphones, tablets, and Smart TVs. Third, we eliminate installation fees and technician visits entirely; setup is completely self-service and takes only 5 minutes using our step-by-step guides. Fourth, our content delivery via internet streaming is more efficient than traditional broadcast methods. Finally, we operate without long-term contracts or early termination penalties, which means we compete on value rather than locking customers into expensive agreements. The result is that you get 20-30 times more content (50,000+ channels versus 200-500 on cable) for about one-quarter of the price.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                Multi-connection refers to the number of devices that can stream content simultaneously using your subscription. If you select "1 Screen," only one device can watch at a time—if someone else tries to log in and watch, it will disconnect the first device. With "2 Screens," two devices can watch completely different content at the same time without interfering with each other. For example, one person could be watching live sports on a Fire TV in the living room while another watches a movie on a tablet in the bedroom. Whether you need multi-connection depends on your household situation. Single individuals or couples who typically watch TV together can usually get by with 1 screen. Families with children or roommates sharing the service will almost always need 2 or 3 screens to avoid conflicts. Each additional screen costs only $10 more per month, which is far cheaper than cable companies who charge $10-15 per month just to rent each additional cable box. Our multi-connection system works across any device type, so your screens can be a mix of Fire TV, Android box, smartphone, tablet, or Smart TV—whatever you prefer.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                Payment is simple and secure. When you click "Subscribe Now" on any plan, you'll open a checkout popup that allows you to complete payment via WhatsApp or direct contact with our billing team. We accept all major payment methods including credit cards, PayPal, cryptocurrency, and international payment systems. Your service activates within minutes of payment confirmation—not hours or days. You'll immediately receive a welcome email containing your Xtream Codes login credentials (server URL, username, and password) and links to download the recommended IPTV player apps for your devices. From the moment you receive that email, you can start watching. There are no activation fees, no setup charges, and no hidden costs. Your subscription period starts the day you activate, and you'll receive a reminder email 3 days before your plan expires so you have time to renew if you wish to continue service.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                Yes, plan changes are flexible and handled on a case-by-case basis. If you want to add extra screens (upgrade from 1 to 2 screens, for example), contact our support team and we can activate additional connections on your existing account for a prorated fee based on your remaining subscription time. If you'd like to switch from a monthly plan to a longer-term plan to save money, we can credit your unused time toward the new plan. Downgrades (reducing screens or switching to a shorter plan) are processed at renewal time to keep billing simple. The key point is that you're never locked in—if your situation changes, we work with you to adjust your service rather than forcing you to keep paying for features you don't need.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                When your subscription period ends, your service will simply stop working—your login credentials will no longer authenticate and you won't be able to stream. There are no penalties, no cancellation fees, and no automatic renewals that charge your card without permission. Your account remains in our system for 30 days after expiration, so if you decide to renew within that window, we can reactivate your existing account with the same credentials. After 30 days of inactivity, the account is permanently deleted for security and privacy reasons, and you'd need to sign up as a new customer if you want to return. This no-commitment approach means you're only paying for the service when you're actively using it, with complete freedom to start and stop as your needs change.
                            </p>
                        </div>
                    </div>
                </div>
