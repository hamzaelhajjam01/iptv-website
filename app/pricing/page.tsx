...
const PricingPage: React.FC = () => {
    ...
    const pricingSchema = {
        ...
        "image": [
            ...
            "https://streamversetv.com/images/boxes/Box_IPTV_MONTH3.png"
        ],
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div className="flex-1 text-left">
                                ...
                                <p className="text-gray-300 leading-relaxed mb-4">
                                    StreamVerse offers <span className="text-white font-medium">premium IPTV service</span> at significantly lower costs than cable, eliminating expensive hardware rentals and long-term contracts. With plans starting at just <span className="text-white font-medium">$19.99</span>, you gain access to:
                                </p>
                ...
                <div id="pricing-cards" className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-12 mb-16">
                    ...
                    <div className="bg-card-dark p-8 rounded-lg border-2 border-gray-700 flex flex-col">
                        <div className="mb-4 relative w-full h-64">
                            <Image src="/images/boxes/Box_IPTV_MONTH3.png" alt="3 Months Plan" fill className="object-contain" />
                        </div>
                        ...
                        <button onClick={() => openCheckout(`${t('plan1Title')} - ${screens} Screen${screens > 1 ? 's' : ''}`, `$${(19.99 + (screens - 1) * 10).toFixed(2)}`, '/images/boxes/Box_IPTV_MONTH3.png')} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg cta-button text-center">{t('planCTA')}</button>
                    </div>
