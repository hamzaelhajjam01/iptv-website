                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            ...
                            <div className="bg-card-dark p-8 rounded-lg border-2 border-gray-700 flex flex-col hover:border-blue-500/50 transition-all duration-300">
                                <div className="mb-4 relative w-full h-48">
                                    <Image src="/images/boxes/Box_IPTV_MONTH3.png" alt="3 Months USA IPTV Plan" fill className="object-contain" />
                                </div>
                                ...
                                <button
                                    onClick={() => openCheckout('USA 3 Months Plan - 1 Screen', '$19.99', '/images/boxes/Box_IPTV_MONTH3.png')}
