                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            ...
                            <div className="bg-card-dark p-8 rounded-lg border-2 border-gray-700 flex flex-col hover:border-blue-500/50 transition-all duration-300">
                                <div className="mb-4 relative w-full h-48">
                                    <Image src="/images/boxes/Box_IPTV_MONTH1.png" alt="1 Month Samsung TV IPTV Plan" fill className="object-contain" />
                                </div>
                                ...
                                <button
                                    onClick={() => openCheckout('Samsung TV Monthly Plan - 1 Screen', '$9.99', '/images/boxes/Box_IPTV_MONTH1.png')}
