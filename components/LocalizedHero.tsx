...
const LocalizedHero: React.FC<{ src?: string }> = ({ src }) => {
    const { t } = useLanguage();
    return (
        <section className="relative text-white text-center overflow-hidden min-h-[500px]">
            {/* High-Quality Landscape Backdrop - LCP Optimized */}
            <div className="absolute inset-0 z-0">
                <Image 
                    src="/images/hero-background.png" 
                    alt="Premium IPTV streaming interface" 
                    fill
                    priority
            ...
            <div className="relative z-20 container mx-auto max-w-4xl px-6 py-20 md:py-32">
                <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4" dangerouslySetInnerHTML={{ __html: t('heroTitle') }} />
