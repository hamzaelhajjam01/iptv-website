          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-blue-900/20 border border-blue-500/20 rounded-lg p-3 mt-4">
                ...
                <p className="text-xs text-[#25D366] flex items-start gap-2">
                  ...
                  <span><strong>IMPORTANT:</strong> You will be redirected to WhatsApp to complete your payment and receive your credentials securely.</span>
                </p>
              </div>
              ...
              <button
                ...
                className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-3 px-5 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm mt-4"
              >
                {isSubmitting ? (
                  <>
