                ...
                <table ref={tableRef} className="comparison-table w-full min-w-[700px]">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="highlight whitespace-normal md:whitespace-nowrap">50,000+</td>
                        ...
                        <tr className="bg-gray-800">
                            ...
                            <td className="cost text-green-400 highlight whitespace-normal md:whitespace-nowrap">$19.99</td>
